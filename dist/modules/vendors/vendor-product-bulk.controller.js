...
exports.importProducts = exports.downloadTemplate = exports.exportProducts = void 0;
    ...
    try {
        ...
        const csvRows = products.map(p => {
            ...
            return [
                ...
                escape(p.metaTitle || ''), escape(p.metaDescription || '')
            ].join(',');
        });
...
//# sourceMappingURL=vendor-product-bulk.controller.js.map